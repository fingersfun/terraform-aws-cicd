...
```hcl
module "build" {
    source              = "git::https://github.com/fingersfun/terraform-aws-cicd.git?ref=master"
    namespace           = "global"
    name                = "app"
    stage               = "staging"
...
| namespace |"global" |Namespace, which could be your organization name, e.g. 'cp' or 'fingersfun'|
...
File a GitHub [issue](https://github.com/fingersfun/terraform-aws-cicd/issues), send us an [email](mailto:info@fingersfun.com) or reach out to us on [Gitter](https://gitter.im/fingersfun/).

## Contributing

### Bug Reports & Feature Requests

Please use the [issue tracker](https://github.com/fingersfun/terraform-aws-cicd/issues) to report any bugs or file feature requests.

### Developing

If you are interested in being a contributor and want to get involved in developing `terraform-aws-cicd`, we would love to hear from you! Shoot us an [email](mailto:info@fingersfun.com).
...
[APACHE 2.0](LICENSE) © 2017 [FingersFun](https://fingersfun.com.com)
...
This project is maintained and funded by [Cloud Posse, LLC][website]. Like it? Please let us know at <info@fingersfun.com>

We love [Open Source Software](https://github.com/fingersfun/)!

See [our other projects][community]
or [hire us][hire] to help build your next cloud-platform.

  [website]: http://fingersfun.com/
  [community]: https://github.com/fingersfun/

...
module "label" {
  source     = "git::https://github.com/fingersfun/terraform-null-label.git?ref=tags/0.3.1"
...
module "build" {
  source             = "git::https://github.com/fingersfun/terraform-aws-codebuild.git?ref=tags/0.6.2"
  namespace          = "${var.namespace}"
  name               = "${var.name}"
  stage              = "${var.stage}"
